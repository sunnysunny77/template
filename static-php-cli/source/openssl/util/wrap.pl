...
BEGIN {
    ...
    require '/Users/pcone/Documents/GitHub/template/static-php-cli/source/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/pcone/Documents/GitHub/template/static-php-cli/source/openssl/test/fips-and-base.cnf';
    shift;
